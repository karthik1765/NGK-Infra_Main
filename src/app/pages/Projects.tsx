...
const PROJECTS = [
  {
    ...
    desc: "NGK Project 1 is a selective venture raised amidst greenery near Bhogapuram Airport — a beautiful spot far from pollution with perfect Vastu and all legal clearances.",
  },
  {
    name: "NGK Project 2",
    ...
    highlights: [
      ...
      "10 mins' drive from Bhogapuram International Airport",
      "VMRDA Approved Project with 100% Vastu",
      "Underground Drainage System, Footpath & BT Roads",
      "Walkable distance to IT Hub & 5 km from Data Center",
      "Grand Entrance Arch, Compound Wall & Electricity",
    ],
    tag: "Direct Highway Facing 330 Feet NH-16",
    image: "/projects/ngk-project-2/page1.jpg",
    status: "Ongoing",
    slug: "nh16-highway-plots",
    desc: "NGK Project 2 is a premier VMRDA-approved plotted layout directly facing the 330 Feet NH-16 Highway in Bhogapuram. Located just 10 minutes from Bhogapuram International Airport and walkable distance to the IT Hub, it features a grand entrance arch, underground drainage, BT roads, and full legal approvals.",
  },
  {
    name: "NGK Project 3",
    location: "Ginnivanipalem, Pedagantyada, Visakhapatnam",
    type: "Premium Residential Plots – Sree Vaaraahi Gardens",
    units: "Plots Available",
    area: "Spacious Layout",
    config: "Multiple Sizes",
  ...
  },
  {
    ...
    highlights: [
      "Very close to Bhogapuram International Airport",
      "Club House, Swimming Pool & Open Auditorium",
      "2.5 km distance to NH-16 & Miracle City",
      "15 min drive to Vizianagaram & NRI Medical College",
      "Indoor & Outdoor Games (Net Cricket, Volleyball, Pickleball, Snooker)",
      "Avenue Plantation, Black Top Roads & 100% Vaastu",
    ],
    tag: "Very close to Bhogapuram Airport",
    image: "/projects/ngk-project-5/page1.jpg",
    status: "Ongoing",
    slug: "vishal-estates-phase-3",
    desc: "NGK Project 5 (Vishal Estates Phase-III) is a selective venture raised amidst greenery near Bhogapuram Airport — offering Club House, Swimming Pool, Open Auditorium, and full legal clearance with perfect Vastu.",
  },
  {
    name: "NGK Project 6",
