...
const PROJECTS = [
  ...
  },
  {
    ...
    gallery: [
      { src: "/projects/sree-vaaraahi-gardens/page1.png", caption: "Master Layout Plan" },
      { src: "/projects/sree-vaaraahi-gardens/page2.jpg", caption: "Project Overview" },
      { src: "/projects/sree-vaaraahi-gardens/page3.png", caption: "Site — Neighbourhood" },
      { src: "/projects/sree-vaaraahi-gardens/page4.png", caption: "Site — Plot Area" },
      { src: "/projects/sree-vaaraahi-gardens/page5.jpg", caption: "Highlights & Pricing" },
    ],
  },
  {
    name: "NGK Project 4",
