...
const PROJECT_DATA = {
  ...
  "nh16-highway-plots": {
    name: "NGK Project 2",
    subtitle: "Direct Highway Facing 330 Feet NH-16 — VMRDA Approved Layout",
    location: "Vempadam Village, Bhogapuram Visakhapatnam",
    type: "VMRDA Approved Plots",
    units: "Plots Available",
    area: "Spacious Layout",
    config: "Multiple Sizes",
    status: "Ongoing",
    tag: "Direct Highway Facing 330 Feet NH-16",
    desc: "NGK Project 2 offers prime VMRDA-approved residential plots situated directly facing the 330 Feet NH-16 Highway at Vempadam Village, Bhogapuram. Positioned just 10 minutes from Bhogapuram International Airport and near major IT hubs, data centers, and international schools, this layout is fully equipped with grand entrance arch, underground drainage system, BT roads, avenue plantation, electricity, and 100% Vastu compliance.",
    highlights: [
      "Direct Highway Facing 330 Feet NH-16",
      "10 minutes' drive from Bhogapuram International Airport",
      "VMRDA Approved Project",
      "Walkable distance to the IT Hub",
      "5 km from the Data Center",
      "Grand Entrance Arch & Compound Wall",
      "BT Roads & Underground Drainage System",
      "Footpath, Electricity, Name Boards & Plotting Stones",
      "Avenue Plantation, Beautiful Park & 100% Vastu",
      "Excellent connectivity to Visakhapatnam, Vizianagaram & Srikakulam",
      "Near Civil Aviation University, GMR & KVR International Schools",
      "Near premium 5-star hotels like Mayfair, Oberoi & Taj",
    ],
    coverImage: "/projects/ngk-project-2/page1.jpg",
    gallery: [
  ...
  "sree-vaaraahi-gardens": {
    name: "NGK Project 3",
    subtitle: "More Than Just a Plot... It's a Lifestyle!",
    location: "Ginnivanipalem, Pedagantyada, Visakhapatnam",
    ...
    desc: "Sree Vaaraahi Gardens is a premium residential plot venture located at Ginnivanipalem, Pedagantyada, Visakhapatnam. Strategically positioned near the Steel Plant, AMTZ, and the proposed Metro Station, this project offers an excellent opportunity for both residential living and future investment with all modern infrastructure in place.",
    highlights: [
      "10 KM to Gajuwaka D-Mart",
      "8 KM to Kurmannapalem Bus Stop",
      "3 KM to Steel Plant Main Gate",
      "3 KM to Proposed Metro Station",
      "3 KM to Proposed Coastal Corridor",
      "100 FT Proposed Main Road Facing Layout",
      "Within GVMC Limits",
      "Walking Distance from Radisson Blu 5-Star Hotel",
      "Close to upcoming Central Medical Universities",
      "30-FT & 24-FT Gravel Roads",
      "Compound Wall Around Entire Layout",
      "Grand Entrance Gate & 24/7 CCTV Surveillance",
      "Dedicated Security Room with Security Guard",
